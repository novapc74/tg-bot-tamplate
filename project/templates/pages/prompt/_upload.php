...
<section class="upload-prompt">
    <h1 class="form-menu">Upload Prompt File</h1>
    <form action="/admin/prompt/upload" method="POST" enctype="multipart/form-data">
        <label for="prompt_file">Select a file in <span>JSON</span> or <span>TXT</span> format:</label>
        <input type="file" id="prompt_file" name="prompt_file" accept=".json,.txt" required>
